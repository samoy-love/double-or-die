 ...
 *
 * История ре-бейзлайнов ведётся здесь, а не в отдельном журнале: строка
 * версии и причина её смены должны читаться в одном месте.
 *
 ...
 *           состоянии появились карты на арене и активные пари, а вместе с
 *           ними — раскладка из потоков `bets` и `cards`. Прежние эталоны
 *           записаны в мире, где на арене не лежало ни одной карты.
 ...
 */
export const CONFIG_VERSION = '0.2.2';
