...
const VOICES: Record<SoundName, Voice> = {
  ...
  // Подброс Крупье: свист и шлепок о пол. Работает телеграфом — по нему видно,
  ...
  // Появление Крупье: шорох и смешок. Пространственный сигнал «сейчас будет
  ...
  // Жест Крупье: короткий росчерк, чтобы кривляние на краю арены заметили и
